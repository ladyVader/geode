...
public class ClassPathLoaderIntegrationTest {
  ...
  @Test
  public void testLoadPreviouslyDeployedJars() throws Exception {
  ...
  public void testJarsInExtLib() throws Exception {
    File EXT_LIB_DIR = ClassPathLoader.getLatest().getExtLibDir();

    File subdir = new File(temporaryFolder.getRoot(), "cplju");
    subdir.mkdirs();
